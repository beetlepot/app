...
final class Landing: NSView {
    ...
    init() {
        ...
        preferences.topAnchor.constraint(equalTo: new.bottomAnchor, constant: 30).isActive = true
        preferences.leftAnchor.constraint(equalTo: leftAnchor).isActive = true
        
        capacity.topAnchor.constraint(equalTo: preferences.bottomAnchor, constant: 30).isActive = true
